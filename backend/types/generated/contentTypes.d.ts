...
export interface ApiArtistArtist extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    displayName: 'El Artista (Biograf\u00EDa)';
    pluralName: 'artists';
    singularName: 'artist';
  };
  options: {
...
export interface ApiCareCare extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::care.care'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    steps: Schema.Attribute.Component<'layout.care-step', true>;
    subtitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Gu\u00EDa para la curaci\u00F3n perfecta de tu tatuaje'>;
    title: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Cuidados'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCityRequestCityRequest extends Struct.CollectionTypeSchema {
  collectionName: 'city-requests';
  info: {
    description: 'ATENCI\u00D3N: Aqu\u00ED llegan autom\u00E1ticamente los pedidos del formulario web. NO CREAR MANUALMENTE.';
    displayName: 'Pedidos de Ciudades';
    pluralName: 'city-requests';
    singularName: 'city-request';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    showOnWeb: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    startDate: Schema.Attribute.Date & Schema.Attribute.Required;
    studioLink: Schema.Attribute.String;
...
export interface ApiPopupPopup extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::popup.popup'> &
      Schema.Attribute.Private;
    popupActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    popupImage: Schema.Attribute.Media<'images'>;
    popupSubtitle: Schema.Attribute.String;
...
export interface ApiTattooTattoo extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    displayName: 'Trabajos (Portfolio)';
    pluralName: 'tattoos';
    singularName: 'tattoo';
  };
  options: {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    showOnWeb: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    style: Schema.Attribute.Enumeration<['black_grey', 'color', 'cover_up']> &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::city-request.city-request': ApiCityRequestCityRequest;
